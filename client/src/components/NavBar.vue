<template>
  <div class="navbar-container" >
    <b-navbar id="navbar-container-nav" toggleable="lg" type="dark" variant="info">
      <b-navbar-brand v-on:click="gotoHomePage">ChessMate</b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
       ...
       <b-navbar-nav>
          ...
          <b-nav-item v-on:click="gotoGameData">GameData</b-nav-item>
        </b-navbar-nav>
...
export default {
  methods: {
    ...
    gotoGameData() { this.$router.push('/game_data') }
  }
}
</script>
